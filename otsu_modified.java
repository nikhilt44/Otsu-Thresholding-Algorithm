...
//using standard deviation instead of mean

public class otsu_modified extends PApplet
{
	...
	public void setup()
	{
		  ...
		  //   System.out.println(bg);
		   //  System.out.println(fg);
			...
			// System.out.println(Arrays.toString(bg1));
			 ...
			 //first value of array is weight and second in standard deviation
         	 if(th==50)
			 {
	 ...
	 private float[] calc_fg(Map<Integer, Long> fg,long total) 
	 {
		...
		long temp1=0;
		int temp2=0;
		long total1 = fg.size(); // size of fg map
		float wfg;     //weight
		float mfg;     //mean
		double sfg;	   // standard deviation	
		Set a = fg.keySet();
		for(Object b : a)
		{
		   sum += fg.get(b); 
		...
		wfg = (float)sum/total;
		float mean = sum/total1;
	//	System.out.println(mean);
		mfg = temp/sum;
		for(Object b : a)
		{
			temp1 = fg.get(b); 
			temp2 += pow(temp1-mean,2);  	
		}
		sfg = Math.sqrt(temp2/total);
	//	System.out.println(sfg);
		float[] w = {wfg,(float)sfg};
		return w;
	}
	...
	private float[] calc_bg(Map<Integer, Long> bg,long total) 
	{
		// TODO Auto-generated method stub
				...
				long temp1=0;
				int temp2=0;
				long total1 = bg.size(); // size of fg map
				float wbg;     //weight
				float mbg;     //mean
				double sbg;	   // standard deviation	
				Set a = bg.keySet();
				for(Object b : a)
				{
				   sum += bg.get(b); 
			...
			//	System.out.println(mean);
				...
				sbg = Math.sqrt(temp2/total);
			//	System.out.println(sfg);
				float[] w = {wbg,(float)sbg};
				return w;				
	}
